...
class _DriveViewController: UIViewController, CLLocationManagerDelegate, MKMapViewDelegate, UIGestureRecognizerDelegate {

    var route: CDRoute! // A list of Waypoint objects
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        group.enter()
        routeMan.getRoutes(waypoints: Array(route!.waypoints!) as! [CDWaypoint])  { (routes) in
